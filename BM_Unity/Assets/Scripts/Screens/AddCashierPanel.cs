...
namespace Screens
{
    public class AddCashierPanel : BaseScreen
    {
        ...
        private void Awake()
        {
            if (ScreensService.AddCashierPanel == null)
                ScreensService.AddCashierPanel = this;
        ...
        private void Reset()
        {
            _name.text = LocalizationService.DefaultCashierName;
