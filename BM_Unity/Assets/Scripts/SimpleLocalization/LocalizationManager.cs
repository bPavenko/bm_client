...
namespace Assets.SimpleLocalization
{
    ...
    public static class LocalizationManager
    {
        ...
        public static string Language
        {
            ...
            set { _language = Application.platform == RuntimePlatform.OSXEditor ? "Russian" : value; LocalizationChanged(); }
        }
		...
		public static string Localize(string localizationKey)
        {
			...
			if (Language == "Russian") return Dictionary[Language][localizationKey];
	        ...
	        if (!Dictionary[Language].ContainsKey(localizationKey)) return "Skip localization";
